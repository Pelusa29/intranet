    ...
    var e = "metisMenu",
      ...
      return s.init = function () {
        ...
        return this.each(function () {
          var s = n(this),
              r = s.data("metisMenu"),
              o = t({}, a, s.data(), "object" == _typeof(i) && i ? i : {});
...
!function (n) {
  ...
  n(document).ready(function () {
    ...
    var a = function a(n, _a, e, t) {
      var i = "margin-top",
          o = {};
      return n && (i = "margin-bottom"), o[i] = _a + "px", o.opacity = e, t && (o.display = "block"), o;
    };
  ...
  n.fn.niftyMega = function (a) {
    var t = !1;
    return this.each(function () {
      o[a] ? t = o[a].apply(n(this), Array.prototype.slice.call(arguments, 1)) : "object" != _typeof(a) && a || e(n(this));
    }), t;
  }, n(document).on("nifty.ready", function () {
  ...
  n.fn.niftyOverlay = function (a) {
    return t[a] ? t[a](this) : "object" != _typeof(a) && a ? null : this.each(function () {
      i(n(this), a);
    });
  };
}(jQuery), !function (n) {
  ...
  n.niftyNoty = function (f) {
    ...
    (function () {
      if (g.onShow(), "page" === g.container) a || (a = n('<div id="page-alert"></div>'), i && i.length || (i = n("#content-container")), i.prepend(a)), e = a, g.focus && y(0);else if ("floating" === g.container) {
        if (!r[g.floating.position]) {
          ...
          if ("top" == f) o || (o = n('<div id="floating-top-container" class="floating-container"></div>'), t.append(o)), d = o;else if ("center" == f) s || (s = n('<div id="floating-center-container" class="floating-container"></div>'), t.append(s)), d = s;else {
  ...
  var a = {
    ...
    onChange: null
      ...
      e = function e(_e, t) {
    var i = n.extend({}, a, t),
        o = _e.find(".lang-selected"),
        s = o.parent(".lang-selector").siblings(".dropdown-menu"),
        l = s.find("a"),
        r = l.filter(".active").find(".lang-id").text(),
        c = l.filter(".active").find(".lang-name").text(),
        d = function d(n) {
      l.removeClass("active"), n.addClass("active"), o.html(n.html()), r = n.find(".lang-id").text(), c = n.find(".lang-name").text(), _e.trigger("onChange", [{
        id: r,
        name: c
    ...
    l.on("click", function (a) {
      i.dynamicMode && (a.preventDefault(), a.stopPropagation()), _e.dropdown("toggle"), d(n(this));
  ...
  n.fn.niftyLanguage = function (a) {
    var i = !1;
    return this.each(function () {
      t[a] ? i = t[a].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != _typeof(a) && a || e(n(this), a);
    }), i;
  };
}(jQuery), !function (n) {
  "use strict";
  ...
  n.fn.niftyCheck = function (a) {
    var i = !1;
    return this.each(function () {
      t[a] ? i = t[a].apply(n(this).find("input"), Array.prototype.slice.call(arguments, 1)) : "object" != _typeof(a) && a || e(n(this));
    }), i;
  ...
  var a = null,
    ...
    if (c) return !0;
    var a,
        t = n('#mainnav-menu > li > a, #mainnav-menu-wrap .mainnav-widget a[data-toggle="menu-widget"]');
    t.each(function () {
      var o = n(this),
    ...
    pushToggle: function pushToggle() {
    ...
    colExpToggle: function colExpToggle() {
    ...
    staticPosition: function staticPosition() {
  ...
  var a,
      ...
      t = n(window),
      i = {
    toggleHideShow: function toggleHideShow() {
    ...
    brightTheme: function brightTheme() {
  ...
  n.fn.niftyAffix = function (a) {
    return this.each(function () {
      var e,
          i = n(this);
      "object" != _typeof(a) && a ? "update" == a ? (i.data("nifty.af.class") || r(), e = i.data("nifty.af.class"), l(i)) : "bind" == a && r() : (e = a.className, i.data("nifty.af.class", a.className)), t.hasClass(e) && !t.hasClass("navbar-fixed") ? i.affix({
        offset: {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/js/nifty.min.js");
/******/ 	
/******/ })()
;