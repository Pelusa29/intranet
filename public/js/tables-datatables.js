...
/*!*******************************************!*\
  !*** ./resources/js/tables-datatables.js ***!
  \*******************************************/
...
$(document).on('nifty.ready', function () {
  ...
  // =================================================================
  $.fn.DataTable.ext.pager.numbers_length = 5; // Basic Data Tables with responsive plugin
  // -----------------------------------------------------------------
  ...
  $('#demo-dt-addrow-btn').on('click', function () {
    t.row.add(['Adam Doe', 'New Row', 'New Row', randomInt(1, 100), '2015/10/15', '$' + randomInt(1, 100) + ',000']).draw();
  });
});
/******/ })()
;